...
write_responserate_sheet <- function(x, outputFile, inputFile=NULL, sheetName="Response Rates") {
...
write_driverscore_sheet <- function(x, outputFile, inputFile=outputFile, sheetName="Engagement Model"){
